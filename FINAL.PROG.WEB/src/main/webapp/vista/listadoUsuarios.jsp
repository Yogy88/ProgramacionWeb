...
<html lang="en">
  ...
  <body style="background-color: dimgrey;" >
	...
	<h1 class="text-center m-2 fs-3">Miembros</h1>
  ...
  <tbody>
   ...
   try{
	   ...
	   while(rs.next()){
		   ...
		   out.println("<a href='#' data-bs-toggle='modal' data-bs-target='#delModal' id='"+id+"' user='"+user+"'><i class='bi bi-trash m 1'></i></a>");
		   out.println("</td>");
		...
		out.println("<div class='text-center m-2 fs-3 text-danger'>LISTADO DE Miembros</h1>");
	   out.println("Error al cargar miembro");
   }
         ...
         <form action="../controller/delUsuario.jsp" method="post">
         	<input type ="hidden" name="idUser" id="idUser">
		      <div class="modal-body text-center">
		          <div class="mb-3">
		            <label for="recipient-name" class="col-form-label">¿Realmente quiere eliminar este Miembro?</label>
...
<div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel">Agregar Miembro</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
