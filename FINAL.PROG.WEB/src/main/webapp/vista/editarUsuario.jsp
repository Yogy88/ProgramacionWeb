	...
	<div class="border rounded m-2 text-center">
		...
		<div class="d-flex justify-content-center">
			<form action="../controller/updUsuario.jsp" method="post">
				...
				<input type="password" name="rePass" id="rePass" value="<%out.println(pass); %>"onkeyup="compararPass()" class="form-control mb-3" placeholder="reingresar contraseña" required>
